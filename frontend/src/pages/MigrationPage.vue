...
<template>
  <div>
    ...
    <div class="grid-2">
      ...
      <div class="card"><div class="card-header"><h3>路由参数</h3></div><pre class="font-mono text-xs" style="background:var(--bg-stat);padding:12px;border-radius:var(--radius-sm);overflow-x:auto;">{{ JSON.stringify(route.params, null, 2) }}</pre></div>
    </div>
