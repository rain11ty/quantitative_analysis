    ...
    <div style="position:fixed;bottom:24px;right:24px;z-index:9999;display:flex;flex-direction:column;gap:6px;pointer-events:none;max-width:340px;" aria-live="polite">
      <TransitionGroup name="toast">
        <div v-for="toast in toasts" :key="toast.id"
          style="padding:10px 16px;border-radius:var(--radius-md);font-size:14px;font-weight:600;cursor:pointer;pointer-events:auto;line-height:1.4;font-family:var(--font-sans);"
          :style="{
