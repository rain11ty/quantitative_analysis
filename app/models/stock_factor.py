...
class StockFactor(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'adj_factor': float(self.adj_factor) if self.adj_factor is not None else None,
            'open_hfq': float(self.open_hfq) if self.open_hfq is not None else None,
            'close_hfq': float(self.close_hfq) if self.close_hfq is not None else None,
            'high_hfq': float(self.high_hfq) if self.high_hfq is not None else None,
            'low_hfq': float(self.low_hfq) if self.low_hfq is not None else None,
            'macd_dif': float(self.macd_dif) if self.macd_dif is not None else None,
            'macd_dea': float(self.macd_dea) if self.macd_dea is not None else None,
            'macd': float(self.macd) if self.macd is not None else None,
            'kdj_k': float(self.kdj_k) if self.kdj_k is not None else None,
            'kdj_d': float(self.kdj_d) if self.kdj_d is not None else None,
            'kdj_j': float(self.kdj_j) if self.kdj_j is not None else None,
            'rsi_6': float(self.rsi_6) if self.rsi_6 is not None else None,
            'rsi_12': float(self.rsi_12) if self.rsi_12 is not None else None,
            'rsi_24': float(self.rsi_24) if self.rsi_24 is not None else None,
            ...
            'cci': float(self.cci) if self.cci is not None else None
        }
